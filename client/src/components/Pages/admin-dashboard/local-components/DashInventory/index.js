...
class DashInventory extends Component {
    ...
    componentDidMount() {
        API.getItems(this.props.sessionToken).then(results => {
                ...
                children: [
                    {
                        ...
                        title: 'new',
                        clr: 'blue',
                        size: itemObj[keyName].newCount
                    },
                    {
                        bigness: 1,
                        title: 'good',
                        clr: 'green',
                        size: itemObj[keyName].goodCount
                    },
                    {
                        bigness: 1,
                        title: 'okay',
                        clr: 'yellow',
                        size: itemObj[keyName].okayCount
                    },
                    {
                        bigness: 1,
                        title: 'bad',
                        clr: 'red',
                        size: itemObj[keyName].badCount
                    }
                ],
                labelStyle: {
                    fontSize: 15,
                ...
                children: [
                    {
                        ...
                        title: 'out',
                        clr: 'red',
                        size: itemObj[keyName].outCount
                    },
                    {
                        bigness: 1,
                        title: 'in',
                        clr: 'green',
                        size: itemObj[keyName].inCount
                    }
                ],
                labelStyle: {
                    fontSize: 15,
